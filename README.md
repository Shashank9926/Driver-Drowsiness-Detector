...
Camera → Eye Detection → CNN Model Prediction → Drowsiness Check →
🔊 Alarm Trigger → 🚨 SOS API Call → 🗄 Database Storage
...
Face detected using Haarcascade

Eye regions extracted

Each eye is passed into a trained CNN model

If both eyes are detected closed for 10+ frames, the system:
